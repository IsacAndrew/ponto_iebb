...
export function SuccessToast({message}){
 const ref=useRef();
 useEffect(()=>{const element=ref.current;element.showPopover();return()=>element.hidePopover();},[message]);
 return <div ref={ref} popover="manual" className="toast success-toast" role="status">{message}</div>;
}
