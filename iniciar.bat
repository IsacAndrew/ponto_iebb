...
".venv\Scripts\python.exe" -c "import fastapi,uvicorn,sqlalchemy,openpyxl,dotenv,psycopg,alembic; import zoneinfo; zoneinfo.ZoneInfo('America/Sao_Paulo')" >nul 2>nul
if errorlevel 1 (
